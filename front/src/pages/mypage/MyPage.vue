    ...
    <div class="row justify-center">
      <div class="col-2">
        <div class="row justify-end">
          <div class="col q-pa-md" style="max-width: 200px">
            <q-list padding style="text-align: right">
              <q-item
                clickable
                v-ripple
                :active="link === 'profile'"
      ...
      <div class="col-8" style="max-width: 1140px">
